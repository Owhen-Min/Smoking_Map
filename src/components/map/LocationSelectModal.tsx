...
import { getAddressFromCoords } from "@/lib/map";
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/60 backdrop-blur-sm animate-fade-in">
      <div className="relative w-full max-w-lg bg-surface rounded-3xl shadow-2xl overflow-hidden border border-foreground/5 animate-scale-up flex flex-col max-h-[90vh]">
        {/* 헤더 */}
        <div className="flex items-center justify-between p-5 border-b border-foreground/5 bg-background/50">
          <div>
        ...
        {/* 지도 영역 및 고정 핀 */}
        <div className="relative flex-1 min-h-[350px] bg-foreground/5">
        ...
        {/* 푸터 영역 */}
        <div className="p-5 border-t border-foreground/5 bg-background/50 flex flex-col gap-4">
